describe("Cli for module", {
  it("add_column", {
    ...
    expect_true(testtools::exist_output_file("/workdir/tests/data/cameras_extra_campo_with_date.csv"))
    obtained <- readr::read_csv("/workdir/tests/data/cameras_extra_campo_with_date.csv")
