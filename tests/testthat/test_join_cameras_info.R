describe("join into one table the info from camera traps", {
  revision_campo_df <- readr::read_csv("tests/data/camaras_revision_campo.csv", show_col_types = FALSE)
  revision_memoria_df <- readr::read_csv("tests/data/camaras_revision_memoria.csv", show_col_types = FALSE)
